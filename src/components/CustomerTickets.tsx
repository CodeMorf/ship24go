...
const supportChannels = [
  ...
  },
  {
    ...
    subtitleKey: 'tickets.channels.facebook_global.subtitle',
    href: 'https://www.facebook.com/ship24go/',
    icon: Globe2,
    cardClass: 'from-blue-600 to-blue-700 shadow-blue-500/20'
  },
  {
    id: 'facebook-italy',
    titleKey: 'tickets.channels.facebook_italy.title',
    subtitleKey: 'tickets.channels.facebook_italy.subtitle',
    href: 'https://www.facebook.com/ship4goitaly/',
    icon: Globe2,
    cardClass: 'from-green-600 to-red-600 shadow-green-500/20'
  },
  {
    id: 'facebook-us',
    titleKey: 'tickets.channels.facebook_us.title',
    subtitleKey: 'tickets.channels.facebook_us.subtitle',
    href: 'https://www.facebook.com/ship24gous',
    icon: Globe2,
    cardClass: 'from-indigo-600 to-red-600 shadow-indigo-500/20'
  },
  {
    id: 'facebook-spain',
    titleKey: 'tickets.channels.facebook_spain.title',
    subtitleKey: 'tickets.channels.facebook_spain.subtitle',
    href: 'https://www.facebook.com/Ship24goes',
    icon: Globe2,
    cardClass: 'from-amber-500 to-red-600 shadow-amber-500/20'
  },
  {
    id: 'instagram',
    titleKey: 'tickets.channels.instagram.title',
    subtitleKey: 'tickets.channels.instagram.subtitle',
    href: 'https://www.instagram.com/ship24.go/',
    icon: Instagram,
    cardClass: 'from-pink-500 to-orange-500 shadow-pink-500/20'
  }
];
