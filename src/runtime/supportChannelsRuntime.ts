...
const labels: Record<Lang, any> = {
  es: {
    ...
    open: 'Abrir',
    whatsappText: 'Hola Ship24Go, necesito ayuda con un envío.'
  },
  en: {
    ...
    open: 'Open',
    whatsappText: 'Hello Ship24Go, I need help with a shipment.'
  },
  it: {
    ...
    open: 'Apri',
    whatsappText: 'Ciao Ship24Go, ho bisogno di assistenza con una spedizione.'
  },
  fr: {
    ...
    open: 'Ouvrir',
    whatsappText: 'Bonjour Ship24Go, j’ai besoin d’aide avec un envoi.'
  },
  de: {
    ...
    open: 'Öffnen',
    whatsappText: 'Hallo Ship24Go, ich brauche Hilfe mit einer Sendung.'
  },
  zh: {
    title: '官方支持渠道',
    ...
    open: '打开',
    whatsappText: '你好 Ship24Go，我需要运单帮助。'
  }
};
...
const channels = (l: any) => [
  ...
  },
  {
    icon: 'f',
    title: l.global,
    subtitle: 'facebook.com/ship24go',
    href: 'https://www.facebook.com/ship24go/',
    className: 'from-blue-600 to-blue-700'
  },
  {
    icon: '🇮🇹',
    title: l.italy,
    subtitle: 'facebook.com/ship4goitaly',
    href: 'https://www.facebook.com/ship4goitaly/',
    className: 'from-green-600 to-red-600'
  },
  {
    icon: '🇺🇸',
    title: l.usa,
    subtitle: 'facebook.com/ship24gous',
    href: 'https://www.facebook.com/ship24gous',
    className: 'from-blue-700 to-red-600'
  },
  {
    icon: '🇪🇸',
    title: l.spain,
    subtitle: 'facebook.com/Ship24goes',
    href: 'https://www.facebook.com/Ship24goes',
    className: 'from-yellow-500 to-red-600'
  },
  {
    icon: '◎',
    title: l.instagram,
    subtitle: 'instagram.com/ship24.go',
    href: 'https://www.instagram.com/ship24.go/',
    className: 'from-pink-500 to-orange-500'
  }
];
...
const render = () => {
  ...
  section.innerHTML = `
    <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-2 mb-4">
      <div>
        <p class="text-[11px] font-black uppercase tracking-[0.18em] text-blue-600 dark:text-cyan-300">Ship24Go</p>
