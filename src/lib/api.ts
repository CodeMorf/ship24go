...
export const api = {
  ...
  requestPointPayout: (data: any) => fetchAPI('/point/payout-request', { method: 'POST', body: JSON.stringify(data) }),
  getPointPayoutRequests: () => fetchAPI('/point/payout-requests'),
  getPointFinanceSummary: () => fetchAPI('/point/finance/summary'),
  openPointCashShift: (data: any) => fetchAPI('/point/cash/open-shift', { method: 'POST', body: JSON.stringify(data) }),
  closePointCashShift: (data: any) => fetchAPI('/point/cash/close-shift', { method: 'POST', body: JSON.stringify(data) }),
  getPointEmployees: () => fetchAPI('/point/employees'),
  savePointEmployee: (data: any) => fetchAPI('/point/employees', { method: 'POST', body: JSON.stringify(data) }),
  updatePointEmployeeStatus: (id: string, status: string) => fetchAPI(`/point/employees/${encodeURIComponent(id)}/status`, { method: 'POST', body: JSON.stringify({ status }) }),
  deletePointEmployee: (id: string) => fetchAPI(`/point/employees/${encodeURIComponent(id)}`, { method: 'DELETE' }),
  getPointCurrentSaca: (category = 'documents') => fetchAPI(`/point/manifests/current-valija?category=${encodeURIComponent(category)}`),
  closePointSaca: (data: any) => fetchAPI('/point/manifests/close-valija', { method: 'POST', body: JSON.stringify(data) }),
  getPointManifests: () => fetchAPI('/point/manifests'),
  getPointPublicBranches: () => fetchAPI('/point/public-branches'),
  getPointBranchPublicEmployees: (branchId: string) => fetchAPI(`/point/branch/${encodeURIComponent(branchId)}/employees-public`),
  loginPointEmployee: (data: any) => fetchAPI('/point/auth/employee-login', { method: 'POST', body: JSON.stringify(data) }),
  linkPointDevice: (data: any) => fetchAPI('/point/devices/link', { method: 'POST', body: JSON.stringify(data) }),
  getPointDevices: () => fetchAPI('/point/devices'),
  revokePointDevice: (id: string) => fetchAPI(`/point/devices/${encodeURIComponent(id)}/revoke`, { method: 'POST' }),
  verifyPointDevice: (data: any) => fetchAPI('/point/devices/verify', { method: 'POST', body: JSON.stringify(data) }),
  unlinkPointDevice: (data: any) => fetchAPI('/point/devices/unlink', { method: 'POST', body: JSON.stringify(data) }),
  updatePointSettings: (data: any) => fetchAPI('/point/settings', { method: 'POST', body: JSON.stringify(data) }),
  sendPointShipmentReceipt: (trackingCode: string, data: any) => fetchAPI(`/point/shipments/${encodeURIComponent(trackingCode)}/send-receipt`, { method: 'POST', body: JSON.stringify(data) }),
  ...
  getAdminTariffs: () => fetchAPI('/admin/tariffs'),
  createAdminTariff: (data: any) => fetchAPI('/admin/tariffs', { method: 'POST', body: JSON.stringify(data) }),
  updateAdminTariff: (id: string, data: any) => fetchAPI(`/admin/tariffs/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
  deleteAdminTariff: (id: string) => fetchAPI(`/admin/tariffs/${id}`, { method: 'DELETE' }),
  getAdminHubs: () => fetchAPI('/admin/hubs'),
  saveAdminHub: (data: any) => fetchAPI('/admin/hubs', { method: 'POST', body: JSON.stringify(data) }),
