...
const STORES_COPY: Record<string, any> = {
  es: {
    ...
    importedOrders: 'Pedidos importados', importedHint: 'Listos para cotizar y generar label.', addressAlerts: 'Direcciones por revisar', addressHint: 'Evita retrasos antes de comprar etiquetas.', shipmentsCreated: 'Envíos creados', shipmentsHint: 'Pedidos vinculados a Ship24Go.',
