/** Swagger UI HTML for Ship24Go (clean AllSender-style) */
...
export function swaggerUiHtml(opts?: { openapiUrl?: string; title?: string; embed?: boolean }): string {
  ...
  const title = opts?.title || 'Ship24Go API — Docs';
  ...
  <header class="ship24-topbar">
    <div class="ship24-brand">
      <img src="/brand/logo.png" alt="Ship24Go" onerror="this.style.display='none'" />
      <span>Ship24Go API</span>
